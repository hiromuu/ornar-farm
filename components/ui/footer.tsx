    ...
    <footer className="bg-gray-50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">Ornar Farm</h3>
            <p className="text-gray-600 text-sm">
              都市と農村をつなぐ新しい農業体験
            </p>
          </div>
          <div>
            <h4 className="text-sm font-semibold mb-4">ナビゲーション</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold mb-4">SNS</h4>
